...
public class MultiplayerTest {
    ...
    public void shouldNextLevel_whenFinishCurrent() {
        ...
        // then
        verifyAllEvents(
                "listener(0) => [WIN(gold=0, multiple)]\n");
    ...
    public void shouldSeveralPlayersCollectionAtLastLevel() {
        ...
        // then
        verifyAllEvents(
                "listener(1) => [WIN(gold=0, multiple)]\n");
    ...
    public void shouldDrawLaserDeath() {
        ...
        // then
        verifyAllEvents(
                "listener(0) => [LOSE(multiple)]\n" +
                "listener(1) => [LOSE(multiple)]\n");
    ...
    public void shouldRunEventAfterKillHero_withDeathRayPerk() {
        ...
        verifyAllEvents(
                "listener(0) => [KILL_HERO(kill=1, multiple)]\n" +
                "listener(1) => [LOSE(multiple)]\n");
    }
    ...
    public void shouldAliveOneHero_whenLaserCameInCell() {
        ...
        try {
            ...
            assertEquals("listener(0) => [LOSE(multiple)]\n",
                    events);
        }
    }
    ...
    public void shouldDropPickedGold_onlyOnFloor() {
        ...
        verifyAllEvents(
                "listener(0) => [LOSE(multiple)]\n" +
                "listener(1) => [KILL_HERO(kill=1, multiple)]\n");
    ...
    public void shouldNotFireWinEvent_ifLevelAlreadyPassed() {
        ...
        verifyAllEvents(
                "listener(0) => [WIN(gold=1, multiple)]\n");
